...
namespace VCardix{
    internal class TSModules{
        ...
        public class TS_LinkSystem{
            public const string
            // Main Control Links
            github_link_lv      = "https://raw.githubusercontent.com/turkaysoft/vcardix/main/VCardix/SoftwareVersion.txt",
            github_link_lr      = "https://github.com/turkaysoft/vcardix/releases/latest",
            // Social Links
        ...
        public class TS_ThemeEngine{
            ...
            public static readonly Dictionary<string, Color> LightTheme = new Dictionary<string, Color>{
                ...
                // ACCENT COLOR
                { "AccentColor", Color.FromArgb(20, 120, 109) },
                { "AccentColorHover", Color.FromArgb(22, 133, 120) },
                ...
                { "DataGridSelectionBG", Color.FromArgb(20, 120, 109) },
                { "DataGridSelectionFE", Color.White },
                //
            ...
            public static readonly Dictionary<string, Color> DarkTheme = new Dictionary<string, Color>{
                ...
                // ACCENT COLOR
                { "AccentColor", Color.FromArgb(71, 158, 161) },
                { "AccentColorHover", Color.FromArgb(76, 170, 173) },
                ...
                { "DataGridSelectionBG", Color.FromArgb(71, 158, 161) },
                { "DataGridSelectionFE", Color.FromArgb(37, 37, 45) },
                //
